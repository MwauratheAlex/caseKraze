                ...
                <Container style={container}>
                    <Section style={message}>
                        ...
                        <Text style={global.text}>
                            We're preparing everything for delivery and wil notify you once your
                            package has been shipped. Delivery usually takes 2 days.
                        </Text>
                        <Text style={{ ...global.text, marginTop: 24 }}>
                            If you have any questions regarding your order,
                            please feel free to contact us with your order number.
                            We are here to help.
                        </Text>
                    </Section>
                    ...
                    <Section style={global.defaultPadding}>
                        <Row style={{ display: "inline-flex", marginBottom: 40, flexDirection: "column" }}>
                    ...
                    <Section style={paddingY}>
                        ...
                        <Row>
                            <Text style={footer.text}>
                                &copy; CaseKraze, Inc. All Rights Reserved.
                            </Text>
                        </Row>
                    </Section>
